...
/**
 * Created by pibigstar on 2018/3/5.
 */

public class PhotoBrowseActivity extends AppCompatActivity{
    int[] imgs = new int[]{R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher, R.mipmap.ic_launcher};
